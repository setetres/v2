...
// 2 - fullscreenBg 1.4 (mod) _ http://gayadesign.com/scripts/fullscreenbackground & http://setetres.st
...
(function ($) {
    ...
    function fillBg(selector, parentobj) {
        var windowHeight = $(parentobj).parent().height();
        var windowWidth = $(parentobj).parent().width();
